...
const suggestions = [
  "اردو گرامر کی بنیادی باتیں سمجھائیں",
  "علامہ اقبال کی شاعری کے بارے میں بتائیں",
  "میں Python سیکھنا چاہتا ہوں، کہاں سے شروع کروں؟",
  "اردو میں ایک مختصر مضمون لکھنے میں مدد کریں",
  "ریاضی کے مسئلے حل کرنے میں مدد کریں",
];
          ...
          {messages.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
              ...
              <p className="text-gray-500 mb-6 max-w-sm" style={{ lineHeight: "2" }}>
                میں آپ کا اردو ذہین معلم ہوں۔ کوئی بھی سوال پوچھیں — اردو، ریاضی، سائنس، یا رمز نویسی!
              </p>
